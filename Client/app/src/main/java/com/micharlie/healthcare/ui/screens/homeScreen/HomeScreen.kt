...
@Composable
fun HomeScreen(navController: NavController, sessionState: Boolean = true, getVideoViewModel: GetVideoViewModel, sharedPreferencesManager: SharedPreferencesManager) {
